...
public class ShortCut extends JFrame {
    ...
    private void createMenuBar() {
        ...
        var newMenuItem = new JMenuItem(new MenuItemAction("Создать файл", iconNew,
                KeyEvent.VK_N));
        var openMenuItem = new JMenuItem(new MenuItemAction("Открыть файл", iconOpen,
                KeyEvent.VK_O));
        var saveMenuItem = new JMenuItem(new
                MenuItemAction("Сохранить файл", iconSave, KeyEvent.VK_S));
